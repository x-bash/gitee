...
# TODO: create a repo named gitee-cli
# TODO: create a repo named gitlab-cli
# TODO: create a repo named github-cli
...
gt.repo.pr.view(){
    ...
    '
    gt.parse_owner_repo
    open_browser "https://gitee.com/${owner}/${repo}/pulls/${id}"
}
